-- Stock-BM adds or refreshes one equipment item by the Portal LAB code.
-- This is deliberately not a full snapshot: an item lookup must never archive
-- other Stock-BM equipment that was not part of the request.
