...
export function ReportsView({ stock }: { stock: StockWorkspace }) {
  return (
    <div className="mx-auto max-w-5xl space-y-5">
      <PageHeader eyebrow="Reports" title="รายงาน / Reports" description="Export สำหรับ Excel และ PDF stock summary" />
